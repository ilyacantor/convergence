...
export const DEMO_POST_MERGE_OVERVIEW = {
  ...
  financial_summary: [
    { label: "Reported EBITDA (acquirer)", acquirer: 61.3, target: null, consolidated: null, format: "currency" as const },
    { label: "Reported EBITDA (target)", acquirer: null, target: 48.7, consolidated: null, format: "currency" as const },
    { label: "Conflict adjustments — revenue", acquirer: null, target: null, consolidated: 10.8, is_derived: true, format: "currency" as const },
    { label: "Conflict adjustments — expense", acquirer: null, target: null, consolidated: 14.2, is_derived: true, format: "currency" as const },
    { label: "Net EBITDA impact of conflicts", acquirer: null, target: null, consolidated: -8.4, is_derived: true, format: "currency" as const },
    { label: "Combined EBITDA (post-reconciliation)", acquirer: null, target: null, consolidated: 101.6, is_derived: true, format: "currency" as const },
  ],
};
