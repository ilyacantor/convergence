  ...
  a_to_b: [
    {
      ...
      current_engagement_revenue_M: 85.0,
    ...
    },
    {
      ...
      current_engagement_revenue_M: 68.0,
    ...
    },
    {
      ...
      current_engagement_revenue_M: 52.0,
    ...
    },
    {
      ...
      current_engagement_revenue_M: 31.0,
    ...
    },
    {
      ...
      current_engagement_revenue_M: 25.0,
  ...
  b_to_a: [
    {
      ...
      current_engagement_revenue_M: 28.0,
    ...
    },
    {
      ...
      current_engagement_revenue_M: 36.0,
    ...
    },
    {
      ...
      current_engagement_revenue_M: 22.0,
    ...
    },
    {
      ...
      contract_recency: 12,
      current_services: ["finance_accounting"],
      current_engagement_revenue_M: 19.0,
...
export const DEMO_QOFE: QofEData = {
  ...
  ebitda_bridge: [
    _adjRow({ name: "Non-recurring legal settlement", category: "non_recurring", entity: "entity_a", current_amount: 48.0, trend: "improving", rationale: "One-time IP litigation settled Q1; no follow-on activity." }),
    _adjRow({ name: "Owner compensation normalization", category: "owner_comp", entity: "entity_a", current_amount: 29.0, rationale: "Partner distribution normalized to market comp schedule." }),
    _adjRow({ name: "Run-rate synergies — shared services", category: "synergy", entity: "combined", current_amount: 62.0, confidence: "medium", rationale: "Shared F&A + HR back-office consolidation, 18-month glide path.", lever: "org_design" }),
    _adjRow({ name: "Procurement rebates underbooked", category: "accounting", entity: "entity_b", current_amount: 17.0, diligence_amount: 17.0, prior_amount: 12.0, trend: "improving", rationale: "Vendor rebate recognition aligned to receipt vs accrual." }),
    _adjRow({ name: "Recruiting capitalized (to expense)", category: "accounting", entity: "entity_a", current_amount: -34.0, trend: "stable", rationale: "Prior capitalization reversed; fully expensed per post-close policy." }),
    _adjRow({ name: "Cloud reservation pricing optimization", category: "cost_action", entity: "entity_b", current_amount: 21.0, confidence: "medium", rationale: "Reserved-instance conversion on AWS/Azure; 3-yr term.", lever: "cloud_optimization" }),
    _adjRow({ name: "Bench cost reduction", category: "cost_action", entity: "entity_a", current_amount: 36.0, confidence: "medium", trend: "improving", rationale: "Utilization improvement from 72% to 78% over two quarters.", lever: "utilization" }),
  ],
  ...
  revenue_quality: {
    ...
    revenue_mix: {
      ...
      consulting_tm_M: 4840.0,
      managed_services_M: 6120.0,
      per_fte_M: 1850.0,
      per_transaction_M: 910.0,
      fixed_fee_M: 1530.0,
    },
    cohort_retention: [
      { years_as_client: 1, total_revenue_M: 224.0 },
      { years_as_client: 2, total_revenue_M: 318.0 },
      { years_as_client: 3, total_revenue_M: 285.0 },
      { years_as_client: 4, total_revenue_M: 249.0 },
      { years_as_client: 5, total_revenue_M: 201.0 },
    ],
    cross_sell_penetration: {
      total_candidates: 11,
      total_pipeline_acv_M: 509.0,
      converted_count: 3,
      converted_acv_M: 147.0,
      conversion_rate_pct: 27,
    },
    upsell_penetration: {
      shared_customers: 8,
      total_gap_services: 9,
      total_expansion_acv_M: 347.0,
      avg_upsell_score: 73,
    },
  },
  ...
  working_capital: {
    ...
    bench_cost_trend: [
      { period: "2024-Q4", value: 86.0 },
      { period: "2025-Q1", value: 78.0 },
      { period: "2025-Q2", value: 71.0 },
      { period: "2025-Q3", value: 64.0 },
      { period: "2025-Q4", value: 59.0 },
    ],
  ...
  summary: {
    reported_ebitda: 613.0,
    entity_adjusted_ebitda: 782.0,
    pro_forma_year_1: 856.0,
    pro_forma_steady_state: 948.0,
    total_adjustments: 7,
